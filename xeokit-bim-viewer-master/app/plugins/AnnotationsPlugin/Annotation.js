...
class Annotation extends Marker {
    ...
    setFromPickResult(pickResult) {
        if (!pickResult.worldPos || !pickResult.worldNormal) {
            ...
            console.log("Setting Annotation from PickResult", pickResult.entity);
            ...
            console.log("Entity type check:", pickResult.entity);
            console.log("Does it have .on?", typeof pickResult.entity?.on);

            this.entity = pickResult.entity;

            console.log("Assigned this.entity =", this.entity);
